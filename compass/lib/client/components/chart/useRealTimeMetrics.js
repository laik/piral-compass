...
export function useRealTimeMetrics(metrics, chartData, params = defaultParams) {
    ...
    if (data.length && metrics.length) {
        ...
        data.push({ x: values[0], y: "0" }, { x: values[1], y: parseFloat(rangeMetrics[index][1]).toFixed(3) }, { x: values[2], y: "0" });
    }
    return data;
}
//# sourceMappingURL=useRealTimeMetrics.js.map