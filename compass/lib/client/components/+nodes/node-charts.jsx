...
export const NodeCharts = observer(() => {
    ...
    const [cpuCapacity, cpuLimits, cpuRequests, cpuUsage, fsSize, fsUsage, memoryCapacity, memoryLimits, memoryRequests, memoryUsage, podCapacity, podUsage] = values;
    // const [
    //   memoryUsage,
    //   memoryRequests,
    //   memoryLimits,
    ...
    return (<BarChart name={`${object.getName()}-metric-${tabId}`} options={options[tabId]} data={{ datasets: datasets[tabId] }}/>);
});
//# sourceMappingURL=node-charts.jsx.map