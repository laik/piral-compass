...
export const ClusterMetricSwitchers = observer(() => {
    ...
    return (<div className="ClusterMetricSwitchers flex gaps">
      <div className="box grow">
        <RadioGroup asButtons className={cssNames("RadioGroup flex gaps", { disabled: disableRoles })} value={metricNodeRole} onChange={(metric) => clusterStore.metricNodeRole = metric}>
      ...
      <div className="box grow metric-switch">
        <RadioGroup asButtons className={cssNames("RadioGroup flex gaps", { disabled: disableMetrics })} value={metricType} onChange={(value) => clusterStore.metricType = value}>
...
//# sourceMappingURL=cluster-metric-switchers.jsx.map