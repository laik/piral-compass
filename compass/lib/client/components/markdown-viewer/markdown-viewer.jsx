...
export class MarkdownViewer extends Component {
    render() {
        ...
        return (<div className={cssNames("MarkDownViewer", className, themeStore.activeTheme.type)} dangerouslySetInnerHTML={{ __html: html }}/>);
    }
}
//# sourceMappingURL=markdown-viewer.jsx.map