...
let LoginComponet = class LoginComponet extends React.Component {
    constructor() {
        super(...arguments);
        this.username = '';
        this.password = '';
    ...
    render() {
        ...
        return (<div className={cssNames("login-main", themeStore.activeTheme.type)}>
        ...
        <div className="login-content">
          <div>
            ...
            <Input maxLength={30} placeholder={`Input your username`} value={this.username} iconLeft="person" validators={systemName} onChange={v => this.username = v}/>
            <SubTitle title={`Password`}/>
            <Input maxLength={30} placeholder={`Input your password`} value={this.password} iconLeft="lock" onChange={v => this.password = v} onKeyDown={e => this.onKeyDown(e)} type="password"/>
...
], LoginComponet.prototype, "username", void 0);
__decorate([
    observable,
    __metadata("design:type", Object)
], LoginComponet.prototype, "password", void 0);
__decorate([
    observable,
    __metadata("design:type", Object)
], LoginComponet.prototype, "loading", void 0);
